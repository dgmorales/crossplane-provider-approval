...
import (
	...
	"github.com/crossplane/provider-approval/internal/controller"
)
...
func main() {
	...
	log := logging.NewLogrLogger(zl.WithName("provider-approval"))
	if *debug {
	...
	mgr, err := ctrl.NewManager(cfg, ctrl.Options{
		...
		LeaderElectionID: "crossplane-leader-election-provider-approval",
